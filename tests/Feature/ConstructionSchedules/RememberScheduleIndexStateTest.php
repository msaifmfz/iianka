...
it('passes the requested schedule index url to the construction schedule detail page', function () {
...
it('passes the requested schedule index url to the business schedule detail page', function () {
    $user = User::factory()->create();
...
it('passes the requested schedule index url to the internal notice detail page', function () {
    $user = User::factory()->create();
...
it('ignores non schedule return urls', function () {
    $user = User::factory()->create();
    $schedule = ConstructionSchedule::factory()->create();
