...
import { ScheduleCalendarSidebar } from '@/components/schedule-calendar-sidebar';
import type {
    CalendarScope,
    CalendarScopeOption,
} from '@/components/schedule-calendar-sidebar';
...
import { useFloatingActionAboveCalendar } from '@/hooks/use-floating-action-above-calendar';
...
export default function ConstructionSchedulesIndex({
    ...
    const calendarScopeOptions: CalendarScopeOption[] = [
        {
            value: 'all',
            label: '全体',
            description: '全員の予定',
    ...
    useIndexScrollRestore(scheduleIndexScrollStorageKey, returnTo);
    const isFloatingActionAboveCalendar = useFloatingActionAboveCalendar(
        canManage,
        calendarAreaRef,
        floatingActionRef,
    );
            ...
            <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_rgba(250,250,249,1),_rgba(239,246,255,0.85))] p-3 md:p-6 dark:bg-[radial-gradient(circle_at_top_left,_rgba(245,158,11,0.18),_transparent_30%),linear-gradient(135deg,_rgba(10,10,10,1),_rgba(23,23,23,1))]">
                <div className="mx-auto grid max-w-7xl gap-5 xl:grid-cols-[320px_1fr]">
                    <ScheduleCalendarSidebar
                        ...
                        hasSelectedUserFilter={hasSelectedUserFilter}
